...
template<>
template<class Ctxt>
RATETYPE reaction<ph7_degradation>::active_rate(const Ctxt& c) const {
...
template<>
template<class Ctxt>
RATETYPE reaction<ph13_degradation>::active_rate(const Ctxt& c) const {
...
template<>
template<class Ctxt>
RATETYPE reaction<pd_degradation>::active_rate(const Ctxt& c) const {
...
template<>
template<class Ctxt>
RATETYPE reaction<ph11_degradation>::active_rate(const Ctxt& c) const {
    return c.getRate(ph11_degradation) * c.getCon(ph11);
}

template<>
template<class Ctxt>
RATETYPE reaction<ph77_degradation>::active_rate(const Ctxt& c) const {
    return c.getRate(ph77_degradation) * c.getCon(ph77);
}

template<>
template<class Ctxt>
RATETYPE reaction<ph1313_degradation>::active_rate(const Ctxt& c) const {
    return c.getRate(ph1313_degradation) * c.getCon(ph1313);
}

template<>
template<class Ctxt>
RATETYPE reaction<ph17_degradation>::active_rate(const Ctxt& c) const {
    return c.getRate(ph17_degradation) * c.getCon(ph17);
}

template<>
template<class Ctxt>
RATETYPE reaction<ph113_degradation>::active_rate(const Ctxt& c) const {
    return c.getRate(ph113_degradation) * c.getCon(ph113);
}

template<>
template<class Ctxt>
RATETYPE reaction<ph713_degradation>::active_rate(const Ctxt& c) const {
...
template<>
template<class Ctxt>
RATETYPE reaction<mh1_degradation>::active_rate(const Ctxt& c) const {
...
template<>
template<class Ctxt>
RATETYPE reaction<md_degradation>::active_rate(const Ctxt& c) const {
...
template<>
template<class Ctxt>
RATETYPE reaction<mh7_degradation>::active_rate(const Ctxt& c) const {
...
template<>
template<class Ctxt>
RATETYPE reaction<mh13_degradation>::active_rate(const Ctxt& c) const {
