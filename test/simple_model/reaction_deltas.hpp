...
STATIC_VAR int num_deltas_synthesis = 1;
STATIC_VAR int deltas_synthesis[] = {1};
STATIC_VAR specie_id delta_ids_synthesis[] = {ASPECIE};

STATIC_VAR int num_deltas_degradation = 1;
STATIC_VAR int deltas_degradation[] = {-1};
STATIC_VAR specie_id delta_ids_degradation[] = {ASPECIE};