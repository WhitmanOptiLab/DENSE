 ...
 ** Last edited by John Stratton (strattja@whitman.edu) Aug 2017    **
 ...
 ** to calculate fitness and constraints and assign to ESPopulation **
 ** fg(x,dim, f, g, count)                                          **
 *********************************************************************/
...
void ESScorePopulation(ESPopulation * population, ESParameter *param, int count);
/*********************************************************************
