...
#include "sim/simulation_methods.h"
...
#ifndef SIMULATION_METHOD
#define SIMULATION_METHOD Determinisitic_Simulation
#endif 

using dense::csvw_sim;
using dense::SIMULATION_METHOD;
...
int main(int argc, char* argv[]){
  ...
  using Simulation = SIMULATION_METHOD;
