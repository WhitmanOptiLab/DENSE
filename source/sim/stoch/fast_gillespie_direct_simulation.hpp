...
public:
 ...
 private:
  ...
  public:
    ...
    */
    Fast_Gillespie_Direct_Simulation(const Parameter_Set& ps, Real* pnFactorsPert, Real** pnFactorsGrad, int cell_count, int width_total, int seed, std::vector<int> conc)
