#include <cmath>
#include "anderson_next_reaction_simulation.hpp"
...
*/
Minutes Anderson_Next_Reaction_Simulation::generateTau(Real propensity) {
...
*/
Minutes Anderson_Next_Reaction_Simulation::getSoonestDelay() const {
  return reaction_schedule.empty() ?
    Minutes{ std::numeric_limits<Real>::infinity() } :
    reaction_schedule.top().second;
}

Minutes Anderson_Next_Reaction_Simulation::time_until_next_event() const {
...
*/
void Anderson_Next_Reaction_Simulation::executeDelayRXN() {
...
*/
void Anderson_Next_Reaction_Simulation::tauLeap(){
...
*/
void Anderson_Next_Reaction_Simulation::fireOrSchedule(int cell, reaction_id rid){
...
void Anderson_Next_Reaction_Simulation::initTau() {
  for( dense::Natural c = 0; c < cell_count(); ++c){
