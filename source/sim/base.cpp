...
dense::Simulation::Simulation(Parameter_Set parameter_set, Natural circumference, NGraph::Graph adj_graph, Real* factors_perturb, Real** factors_gradient) noexcept :
