...
template<>
template<class Ctxt>
RATETYPE reaction<ph1_synthesis>::active_rate(Ctxt const& c) const {
    return c.getRate(ph1_synthesis) * c.getCon(mh1,c.getDelay(dreact_ph1_synthesis));
}

template<>
template<class Ctxt>
RATETYPE reaction<ph1_degradation>::active_rate(Ctxt const& c) const {
    return c.getRate(ph1_degradation) * c.getCon(ph1);
}

template<>
template<class Ctxt>
RATETYPE reaction<ph7_synthesis>::active_rate(Ctxt const& c) const {
    return c.getRate(ph7_synthesis) * c.getCon(mh7,c.getDelay(dreact_ph7_synthesis));
}

template<>
template<class Ctxt>
RATETYPE reaction<ph7_degradation>::active_rate(Ctxt const& c) const {
    return c.getRate(ph7_degradation) * c.getCon(ph7);
}

template<>
template<class Ctxt>
RATETYPE reaction<ph13_synthesis>::active_rate(Ctxt const& c) const {
    return c.getRate(ph13_synthesis) * c.getCon(mh13,c.getDelay(dreact_ph13_synthesis));
}

template<>
template<class Ctxt>
RATETYPE reaction<ph13_degradation>::active_rate(Ctxt const& c) const {
    return c.getRate(ph13_degradation) * c.getCon(ph13);
}

template<>
template<class Ctxt>
RATETYPE reaction<pd_synthesis>::active_rate(Ctxt const& c) const {
    return c.getRate(pd_synthesis) * c.getCon(md,c.getDelay(dreact_pd_synthesis));
}

template<>
template<class Ctxt>
RATETYPE reaction<pd_degradation>::active_rate(Ctxt const& c) const {
    return c.getRate(pd_degradation) * c.getCon(pd);
}

template<>
template<class Ctxt>
RATETYPE reaction<ph11_association>::active_rate(Ctxt const& c) const {
    return c.getRate(ph11_association) * c.getCon(ph1) * c.getCon(ph1);
}

template<>
template<class Ctxt>
RATETYPE reaction<ph77_association>::active_rate(Ctxt const& c) const {
    return c.getRate(ph77_association) * c.getCon(ph7) * c.getCon(ph7);
}

template<>
template<class Ctxt>
RATETYPE reaction<ph1313_association>::active_rate(Ctxt const& c) const {
    return c.getRate(ph1313_association) * c.getCon(ph13) * c.getCon(ph13);
}

template<>
template<class Ctxt>
RATETYPE reaction<ph17_association>::active_rate(Ctxt const& c) const {
    return c.getRate(ph17_association) * c.getCon(ph1) * c.getCon(ph7);
}

template<>
template<class Ctxt>
RATETYPE reaction<ph113_association>::active_rate(Ctxt const& c) const {
    return c.getRate(ph113_association) * c.getCon(ph1) * c.getCon(ph13);
}

template<>
template<class Ctxt>
RATETYPE reaction<ph713_association>::active_rate(Ctxt const& c) const {
    return c.getRate(ph713_association) * c.getCon(ph13) * c.getCon(ph7);
}

template<>
template<class Ctxt>
RATETYPE reaction<ph11_dissociation>::active_rate(Ctxt const& c) const {
    return c.getRate(ph11_dissociation) * c.getCon(ph11);
}

template<>
template<class Ctxt>
RATETYPE reaction<ph77_dissociation>::active_rate(Ctxt const& c) const {
    return c.getRate(ph77_dissociation) * c.getCon(ph77);
}

template<>
template<class Ctxt>
RATETYPE reaction<ph1313_dissociation>::active_rate(Ctxt const& c) const {
    return c.getRate(ph1313_dissociation) * c.getCon(ph1313);
}

template<>
template<class Ctxt>
RATETYPE reaction<ph17_dissociation>::active_rate(Ctxt const& c) const {
    return c.getRate(ph17_dissociation) * c.getCon(ph17);
}

template<>
template<class Ctxt>
RATETYPE reaction<ph113_dissociation>::active_rate(Ctxt const& c) const {
    return c.getRate(ph113_dissociation) * c.getCon(ph113);
}

template<>
template<class Ctxt>
RATETYPE reaction<ph713_dissociation>::active_rate(Ctxt const& c) const {
    return c.getRate(ph713_dissociation) * c.getCon(ph713);
}

template<>
template<class Ctxt>
RATETYPE reaction<ph11_degradation>::active_rate(Ctxt const& c) const {
    return c.getRate(ph11_degradation) * c.getCon(ph11);
}

template<>
template<class Ctxt>
RATETYPE reaction<ph77_degradation>::active_rate(Ctxt const& c) const {
    return c.getRate(ph77_degradation) * c.getCon(ph77);
}

template<>
template<class Ctxt>
RATETYPE reaction<ph1313_degradation>::active_rate(Ctxt const& c) const {
    return c.getRate(ph1313_degradation) * c.getCon(ph1313);
}

template<>
template<class Ctxt>
RATETYPE reaction<ph17_degradation>::active_rate(Ctxt const& c) const {
    return c.getRate(ph17_degradation) * c.getCon(ph17);
}

template<>
template<class Ctxt>
RATETYPE reaction<ph113_degradation>::active_rate(Ctxt const& c) const {
    return c.getRate(ph113_degradation) * c.getCon(ph113);
}

template<>
template<class Ctxt>
RATETYPE reaction<ph713_degradation>::active_rate(Ctxt const& c) const {
    return c.getRate(ph713_degradation) * c.getCon(ph713);
}

template<>
template<class Ctxt>
RATETYPE reaction<mh1_synthesis>::active_rate(Ctxt const& c) const {
...
template<>
template<class Ctxt>
RATETYPE reaction<mh1_degradation>::active_rate(Ctxt const& c) const {
    return c.getRate(mh1_degradation) * c.getCon(mh1);
}

template<>
template<class Ctxt>
RATETYPE reaction<md_synthesis>::active_rate(Ctxt const& c) const {
...
template<>
template<class Ctxt>
RATETYPE reaction<md_degradation>::active_rate(Ctxt const& c) const {
    return c.getRate(md_degradation) * c.getCon(md);
}

template<>
template<class Ctxt>
RATETYPE reaction<mh7_synthesis>::active_rate(Ctxt const& c) const {
...
template<>
template<class Ctxt>
RATETYPE reaction<mh7_degradation>::active_rate(Ctxt const& c) const {
    return c.getRate(mh7_degradation) * c.getCon(mh7);
}

template<>
template<class Ctxt>
RATETYPE reaction<mh13_synthesis>::active_rate(Ctxt const& c) const {
...
template<>
template<class Ctxt>
RATETYPE reaction<mh13_degradation>::active_rate(Ctxt const& c) const {
