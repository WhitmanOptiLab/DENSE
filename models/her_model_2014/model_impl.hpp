...
template<>
RATETYPE reaction<ph1_degradation>::active_rate(const simulation::Context& c) const {
    return c.getRate(ph1_degradation) * c.getCon(ph1);
}

template<>
RATETYPE reaction<ph7_synthesis>::active_rate(const simulation::Context& c) const {
    return c.getRate(ph7_synthesis) * c.getCon(mh7,c.getDelay(dreact_ph7_synthesis));
}

template<>
RATETYPE reaction<ph7_degradation>::active_rate(const simulation::Context& c) const {
    return c.getRate(ph7_degradation) * c.getCon(ph7);
}

template<>
RATETYPE reaction<ph13_synthesis>::active_rate(const simulation::Context& c) const {
    return c.getRate(ph13_synthesis) * c.getCon(mh13,c.getDelay(dreact_ph13_synthesis));
}

template<>
RATETYPE reaction<ph13_degradation>::active_rate(const simulation::Context& c) const {
    return c.getRate(ph13_degradation) * c.getCon(ph13);
}

template<>
RATETYPE reaction<pd_synthesis>::active_rate(const simulation::Context& c) const {
    return c.getRate(pd_synthesis) * c.getCon(md,c.getDelay(dreact_pd_synthesis));
}

template<>
RATETYPE reaction<pd_degradation>::active_rate(const simulation::Context& c) const {
    return c.getRate(pd_degradation) * c.getCon(pd);
}

template<>
RATETYPE reaction<ph11_association>::active_rate(const simulation::Context& c) const {
    return c.getRate(ph11_association) * c.getCon(ph1) * c.getCon(ph1);
}

template<>
RATETYPE reaction<ph77_association>::active_rate(const simulation::Context& c) const {
    return c.getRate(ph77_association) * c.getCon(ph7) * c.getCon(ph7);
}

template<>
RATETYPE reaction<ph1313_association>::active_rate(const simulation::Context& c) const {
    return c.getRate(ph1313_association) * c.getCon(ph13) * c.getCon(ph13);
}

template<>
RATETYPE reaction<ph17_association>::active_rate(const simulation::Context& c) const {
    return c.getRate(ph17_association) * c.getCon(ph1) * c.getCon(ph7);
}

template<>
RATETYPE reaction<ph113_association>::active_rate(const simulation::Context& c) const {
    return c.getRate(ph113_association) * c.getCon(ph1) * c.getCon(ph13);
}

template<>
RATETYPE reaction<ph713_association>::active_rate(const simulation::Context& c) const {
    return c.getRate(ph713_association) * c.getCon(ph13) * c.getCon(ph7);
}

template<>
RATETYPE reaction<ph11_dissociation>::active_rate(const simulation::Context& c) const {
    return c.getRate(ph11_dissociation) * c.getCon(ph11);
}

template<>
RATETYPE reaction<ph77_dissociation>::active_rate(const simulation::Context& c) const {
    return c.getRate(ph77_dissociation) * c.getCon(ph77);
}

template<>
RATETYPE reaction<ph1313_dissociation>::active_rate(const simulation::Context& c) const {
    return c.getRate(ph1313_dissociation) * c.getCon(ph1313);
}

template<>
RATETYPE reaction<ph17_dissociation>::active_rate(const simulation::Context& c) const {
    return c.getRate(ph17_dissociation) * c.getCon(ph17);
}

template<>
RATETYPE reaction<ph113_dissociation>::active_rate(const simulation::Context& c) const {
    return c.getRate(ph113_dissociation) * c.getCon(ph113);
}

template<>
RATETYPE reaction<ph713_dissociation>::active_rate(const simulation::Context& c) const {
    return c.getRate(ph713_dissociation) * c.getCon(ph713);
}

template<>
RATETYPE reaction<ph11_degradation>::active_rate(const simulation::Context& c) const {
    return c.getRate(ph11_degradation) * c.getCon(ph11);
}

template<>
RATETYPE reaction<ph77_degradation>::active_rate(const simulation::Context& c) const {
    return c.getRate(ph77_degradation) * c.getCon(ph77);
}

template<>
RATETYPE reaction<ph1313_degradation>::active_rate(const simulation::Context& c) const {
    return c.getRate(ph1313_degradation) * c.getCon(ph1313);
}

template<>
RATETYPE reaction<ph17_degradation>::active_rate(const simulation::Context& c) const {
    return c.getRate(ph17_degradation) * c.getCon(ph17);
}

template<>
RATETYPE reaction<ph113_degradation>::active_rate(const simulation::Context& c) const {
    return c.getRate(ph113_degradation) * c.getCon(ph113);
}

template<>
RATETYPE reaction<ph713_degradation>::active_rate(const simulation::Context& c) const {
    return c.getRate(ph713_degradation) * c.getCon(ph713);
}

template<>
RATETYPE reaction<mh1_synthesis>::active_rate(const simulation::Context& c) const {
...
template<>
RATETYPE reaction<mh1_degradation>::active_rate(const simulation::Context& c) const {
    return c.getRate(mh1_degradation) * c.getCon(mh1);
}

template<>
RATETYPE reaction<md_synthesis>::active_rate(const simulation::Context& c) const {
...
template<>
RATETYPE reaction<md_degradation>::active_rate(const simulation::Context& c) const {
    return c.getRate(md_degradation) * c.getCon(md);
}

template<>
RATETYPE reaction<mh7_synthesis>::active_rate(const simulation::Context& c) const {
...
template<>
RATETYPE reaction<mh7_degradation>::active_rate(const simulation::Context& c) const {
    return c.getRate(mh7_degradation) * c.getCon(mh7);
}

template<>
RATETYPE reaction<mh13_synthesis>::active_rate(const simulation::Context& c) const {
...
template<>
RATETYPE reaction<mh13_degradation>::active_rate(const simulation::Context& c) const {
