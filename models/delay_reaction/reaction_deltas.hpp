...
STATIC_VAR int num_deltas_reac1 = 2;
STATIC_VAR int deltas_reac1[] = {1, 1};
STATIC_VAR specie_id delta_ids_reac1[] = {specie1,specie2};

STATIC_VAR int num_deltas_reac2 = 3;
STATIC_VAR int deltas_reac2[] = {-2, -2, 1};
STATIC_VAR specie_id delta_ids_reac2[] = {specie1,specie2,specie3};