...
const int out_counts_pm11_dissociation[] = {2};
...
const int out_counts_pm12_dissociation[] = {1,1};
...
const int out_counts_pm22_dissociation[] = {2};
...
const int in_counts_pm11_association[] = {2};
...
const int in_counts_pm12_association[] = {1,1};
...
const int in_counts_pm22_association[] = {2};
